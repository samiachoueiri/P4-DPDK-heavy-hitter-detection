...
{   
    ...
    action a5() {
        user_meta.data4 = h0.get_hash((bit<16>)400, {hdr.tcp.srcPort,hdr.tcp.dstPort,hdr.ipv4.srcAddr,hdr.ipv4.dstAddr}, (bit<16>)32768);
        //user_meta.data3=3;
        //user_meta.data3 = (hdr.tcp.srcPort - hdr.tcp.dstPort + (bit<16>)hdr.ipv4.srcAddr[15:0] - hdr.ipv4.dstAddr[15:0]) % 32768;
    ...
    action a6() {
        user_meta.data5 = h0.get_hash((bit<16>)500, {hdr.tcp.srcPort,hdr.tcp.dstPort,hdr.ipv4.srcAddr,hdr.ipv4.dstAddr}, (bit<16>)32768);
        //user_meta.data3=3;
        //user_meta.data3 = (hdr.tcp.srcPort - hdr.tcp.dstPort + (bit<16>)hdr.ipv4.srcAddr[15:0] - hdr.ipv4.dstAddr[15:0]) % 32768;
    ...
    action a7() {
        user_meta.data6 = h0.get_hash((bit<16>)600, {hdr.tcp.srcPort,hdr.tcp.dstPort,hdr.ipv4.srcAddr,hdr.ipv4.dstAddr}, (bit<16>)32768);
        //user_meta.data3=3;
        //user_meta.data3 = (hdr.tcp.srcPort - hdr.tcp.dstPort + (bit<16>)hdr.ipv4.srcAddr[15:0] - hdr.ipv4.dstAddr[15:0]) % 32768;
    ...
    action a8() {
        user_meta.data7 = h0.get_hash((bit<16>)700, {hdr.tcp.srcPort,hdr.tcp.dstPort,hdr.ipv4.srcAddr,hdr.ipv4.dstAddr}, (bit<16>)32768);
        //user_meta.data3=3;
        //user_meta.data3 = (hdr.tcp.srcPort - hdr.tcp.dstPort + (bit<16>)hdr.ipv4.srcAddr[15:0] - hdr.ipv4.dstAddr[15:0]) % 32768;
    ...
    Register<bit<20>, bit<16>>(32768) reg4;
    Register<bit<20>, bit<16>>(32768) reg5;
    Register<bit<20>, bit<16>>(32768) reg6;
    Register<bit<20>, bit<16>>(32768) reg7;
    ...
    apply {
        ...
        if(hdr.tcp.isValid()) {
            ...
            user_meta.temp_count_4 = reg4.read(user_meta.data4);
            user_meta.temp_count_5 = reg5.read(user_meta.data5);
            user_meta.temp_count_6 = reg6.read(user_meta.data6);
            user_meta.temp_count_7 = reg7.read(user_meta.data7);
            ...
            user_meta.tmp = user_meta.minimum - user_meta.temp_count_4;
            if(user_meta.tmp > 0){
                user_meta.minimum = user_meta.temp_count_4;
            }

            user_meta.tmp = user_meta.minimum - user_meta.temp_count_5;
            if(user_meta.tmp > 0){
                user_meta.minimum = user_meta.temp_count_5;
            }

            user_meta.tmp = user_meta.minimum - user_meta.temp_count_6;
            if(user_meta.tmp > 0){
                user_meta.minimum = user_meta.temp_count_6;
            }

            user_meta.tmp = user_meta.minimum - user_meta.temp_count_7;
            if(user_meta.tmp > 0){
                user_meta.minimum = user_meta.temp_count_7;
            }
            ...
            if(user_meta.minimum > 100000){
                ...
                reg4.write(user_meta.data4,user_meta.temp_count_4+1);
                reg5.write(user_meta.data5,user_meta.temp_count_5+1);
                reg6.write(user_meta.data6,user_meta.temp_count_6+1);
                reg7.write(user_meta.data7,user_meta.temp_count_7+1);
